...
tjek('forsiden linker til alle tretten spil', spilStier.length === 13, spilStier.length + ' stier');
...
const spilSider = ['racer', 'klatbold', 'bobler', 'bogstaver', 'restaurant', 'tegn', 'klokken', 'maskinen', 'rim', 'find', 'flyv', 'have', 'baever'].map(s => fs.readFileSync(path.join(ROD, 'games', s, 'index.html'), 'utf8'));
...
const spilKode = ['racer', 'klatbold', 'bobler', 'bogstaver', 'restaurant', 'tegn', 'klokken', 'maskinen', 'rim', 'find', 'flyv', 'have', 'baever'].map(s => fs.readFileSync(path.join(ROD, 'games', s, 'js', 'game.js'), 'utf8'));
// Hvert spil skal kunne komme tilbage til sin egen menu midt i et spil
const udenMenuKnap = ['racer', 'klatbold', 'bobler', 'bogstaver', 'restaurant', 'tegn', 'klokken', 'maskinen', 'rim', 'find', 'flyv', 'have', 'baever']
