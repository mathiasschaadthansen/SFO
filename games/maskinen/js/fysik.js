...
(function (rod) {
  ...
  var DELE = {
    ...
    // Tragten fanger kuglen oppefra og slipper den lige ned under sig.
    tragt:     { b: 96, h: 64, fanger: true, vinkler: [0] }
  };
  ...
  function nyVerden(bane, lagte) {
    ...
    v.lagte.forEach(function (d, i) {
      ...
      if (s.drejer) {
        ...
        v.tragte.push({ i: i, x: d.x, y: d.y, b: s.b, h: s.h, fanget: 0 });
      } else {
  ...
  function trin(v) {
    ...
    for (var ti = 0; ti < v.tragte.length; ti++) {
      ...
      if (tr.fanget > 0) {
        ...
        if (tr.fanget <= 0) { k.y = tr.y + tr.h * 0.5 + k.r + 1; k.vy = 60; }
        return;
      }
  ...
  var BANER = [
    ...
    { navn: 'grenen', kapitel: 'skoven',
      ...
      mur: [{ x1: 60, y1: 300, x2: 380, y2: 380 }, { x: 620, y: 520, b: 380, h: 60 }],
      hylde: { rampe:  1 },
      loesning: [{ slags: 'rampe', x: 420, y: 480, vinkel: 0 }] },
    { navn: 'to-grene', kapitel: 'skoven',
      start: { x: 140, y: 60 }, maal: { x: 140, y: 555 },
      mur: [{ x1: 60, y1: 200, x2: 400, y2: 290 }, { x1: 940, y1: 330, x2: 560, y2: 420 }, { x: 60, y: 590, b: 240, h: 60 }, { x: -40, y: -200, b: 40, h: 880 }],
      hylde: { trampolin: 1 },
      loesning: [{ slags: 'trampolin', x: 120, y: 160, vinkel: -22 }] },
    { navn: 'hulen', kapitel: 'skoven',
      start: { x: 130, y: 60 }, maal: { x: 880, y: 425 },
      mur: [{ x: 60, y: 260, b: 240, h: 60 }, { x: 420, y: 340, b: 40, h: 280 }, { x: 620, y: 460, b: 380, h: 60 }, { x: 1000, y: -200, b: 40, h: 880 }],
      hylde: { rampe:  1,  blaeser:  1 },
      loesning: [{ slags: 'rampe', x: 520, y: 180, vinkel: 0 }, { slags: 'blaeser', x: 120, y: 200, vinkel: 90 }] },
    { navn: 'svampene', kapitel: 'skoven',
      start: { x: 860, y: 60 }, maal: { x: 140, y: 505 },
      mur: [{ x: 620, y: 300, b: 380, h: 60 }, { x: 60, y: 540, b: 300, h: 60 }, { x: 380, y: 380, b: 40, h: 240 }],
      hylde: { vippe:  1,  rampe:  1 },
      loesning: [{ slags: 'vippe', x: 660, y: 180, vinkel: 0 }, { slags: 'rampe', x: 800, y: 160, vinkel: -20 }] },
    { navn: 'ned-ad-stammen', kapitel: 'skoven',
      start: { x: 120, y: 60 }, maal: { x: 860, y: 545 },
      mur: [{ x: 60, y: 260, b: 260, h: 60 }, { x: 480, y: 260, b: 40, h: 360 }, { x: 640, y: 580, b: 360, h: 60 }, { x: 1000, y: -200, b: 40, h: 880 }],
      hylde: { rampe:  2,  trampolin:  1 },
      loesning: [{ slags: 'rampe', x: 360, y: 120, vinkel: 0 }, { slags: 'rampe', x: 260, y: 480, vinkel: 40 }, { slags: 'trampolin', x: 140, y: 160, vinkel: 22 }] },
    { navn: 'skovens-maskine', kapitel: 'skoven',
      start: { x: 500, y: 60 }, maal: { x: 120, y: 555 },
      mur: [{ x1: 200, y1: 260, x2: 560, y2: 340 }, { x: 700, y: 420, b: 300, h: 60 }, { x: 60, y: 590, b: 260, h: 60 }, { x: 360, y: 440, b: 40, h: 180 }],
      hylde: { baand:  1,  vippe:  1,  blaeser:  1 },
      loesning: [{ slags: 'baand', x: 420, y: 180, vinkel: 180 }, { slags: 'vippe', x: 620, y: 200, vinkel: 0 }, { slags: 'blaeser', x: 640, y: 360, vinkel: 90 }] },
    ...
    { navn: 'aakanden', kapitel: 'soeen',
      ...
      hylde: { rampe:  1 },
      loesning: [{ slags: 'rampe', x: 120, y: 220, vinkel: 40 }] },
    { navn: 'sivene', kapitel: 'soeen',
      start: { x: 120, y: 60 }, maal: { x: 860, y: 505 },
      mur: [{ x: 60, y: 400, b: 300, h: 60 }, { x: 500, y: 200, b: 20, h: 260 }, { x: 720, y: 540, b: 280, h: 60 }],
      hylde: { trampolin:  1,  klods:  1 },
      loesning: [{ slags: 'trampolin', x: 80, y: 240, vinkel: 22 }, { slags: 'klods', x: 280, y: 520, vinkel: 0 }] },
    { navn: 'tragten', kapitel: 'soeen',
      start: { x: 150, y: 60 }, maal: { x: 700, y: 545 },
      mur: [{ x: 60, y: 300, b: 260, h: 60 }, { x: 600, y: 580, b: 200, h: 60 }],
      hylde: { tragt:  1,  rampe:  1 },
      loesning: [{ slags: 'tragt', x: 660, y: 280, vinkel: 0 }, { slags: 'rampe', x: 180, y: 180, vinkel: 40 }] },
    { navn: 'over-vandet', kapitel: 'soeen',
      start: { x: 120, y: 60 }, maal: { x: 880, y: 265 },
      mur: [{ x: 120, y: 520, b: 120, h: 16, stof: 'aakande' }, { x: 440, y: 480, b: 120, h: 16, stof: 'aakande' }, { x: 760, y: 300, b: 240, h: 60 }],
      hylde: { trampolin:  2 },
      loesning: [{ slags: 'trampolin', x: 620, y: 320, vinkel: 0 }, { slags: 'trampolin', x: 160, y: 160, vinkel: 22 }] },
    { navn: 'froens-hop', kapitel: 'soeen',
      start: { x: 860, y: 60 }, maal: { x: 140, y: 425 },
      mur: [{ x: 660, y: 320, b: 340, h: 60 }, { x: 380, y: 520, b: 120, h: 16, stof: 'aakande' }, { x: 60, y: 460, b: 220, h: 60 }],
      hylde: { vippe:  1,  trampolin:  1 },
      loesning: [{ slags: 'vippe', x: 320, y: 260, vinkel: 0 }, { slags: 'trampolin', x: 840, y: 160, vinkel: -22 }] },
    { navn: 'soeens-maskine', kapitel: 'soeen',
      start: { x: 140, y: 60 }, maal: { x: 880, y: 545 },
      mur: [{ x: 60, y: 240, b: 220, h: 60 }, { x: 360, y: 460, b: 120, h: 16, stof: 'aakande' }, { x: 560, y: 300, b: 20, h: 320 }, { x: 740, y: 580, b: 260, h: 60 }],
      hylde: { tragt:  1,  baand:  1,  blaeser:  1 },
      loesning: [{ slags: 'tragt', x: 680, y: 200, vinkel: 0 }, { slags: 'baand', x: 440, y: 300, vinkel: 0 }, { slags: 'blaeser', x: 100, y: 160, vinkel: 90 }] },
    /* Vinter: is der er glat, sne der bremser, og kanonen */
    { navn: 'isen', kapitel: 'vinter',
      start: { x: 120, y: 60 }, maal: { x: 880, y: 505 },
      mur: [{ x: 60, y: 540, b: 940, h: 40, stof: 'is' }],
      hylde: { rampe:  1 },
      loesning: [{ slags: 'rampe', x: 80, y: 360, vinkel: 20 }] },
    { navn: 'snedriven', kapitel: 'vinter',
      start: { x: 120, y: 60 }, maal: { x: 880, y: 445 },
      mur: [{ x: 60, y: 380, b: 500, h: 40, stof: 'is' }, { x: 620, y: 480, b: 380, h: 60, stof: 'sne' }],
      hylde: { trampolin:  1 },
      loesning: [{ slags: 'trampolin', x: 160, y: 220, vinkel: 22 }] },
    { navn: 'kanonen', kapitel: 'vinter',
      ...
      hylde: { kanon:  1 },
      loesning: [{ slags: 'kanon', x: 180, y: 180, vinkel: 45 }] },
    { navn: 'is-og-kanon', kapitel: 'vinter',
      start: { x: 860, y: 60 }, maal: { x: 140, y: 385 },
      mur: [{ x: 560, y: 340, b: 440, h: 40, stof: 'is' }, { x: 420, y: 200, b: 40, h: 420 }, { x: 60, y: 420, b: 240, h: 60 }],
      hylde: { kanon:  1,  rampe:  1 },
      loesning: [{ slags: 'kanon', x: 860, y: 160, vinkel: 270 }, { slags: 'rampe', x: 780, y: 220, vinkel: 40 }] },
    { navn: 'skiloebet', kapitel: 'vinter',
      start: { x: 120, y: 60 }, maal: { x: 860, y: 545 },
      mur: [{ x1: 60, y1: 220, x2: 420, y2: 340, stof: 'is' }, { x1: 940, y1: 380, x2: 600, y2: 470, stof: 'is' }, { x: 640, y: 580, b: 360, h: 60 }],
      hylde: { tragt:  1,  rampe:  1 },
      loesning: [{ slags: 'tragt', x: 320, y: 100, vinkel: 0 }, { slags: 'rampe', x: 520, y: 460, vinkel: 40 }] },
    { navn: 'vinterens-maskine', kapitel: 'vinter',
      start: { x: 140, y: 60 }, maal: { x: 520, y: 545 },
      mur: [{ x: 60, y: 280, b: 260, h: 40, stof: 'is' }, { x: 760, y: 300, b: 240, h: 60, stof: 'sne' }, { x: 420, y: 580, b: 200, h: 60 }, { x: 300, y: 400, b: 40, h: 220 }, { x: 680, y: 400, b: 40, h: 220 }],
      hylde: { kanon:  1,  trampolin:  1,  rampe:  1 },
      loesning: [{ slags: 'kanon', x: 760, y: 140, vinkel: 225 }, { slags: 'trampolin', x: 260, y: 200, vinkel: 0 }, { slags: 'rampe', x: 100, y: 160, vinkel: 20 }] },
    /* Natten: alt paa én gang, i moerket */
    { navn: 'lygten', kapitel: 'natten',
      start: { x: 120, y: 60 }, maal: { x: 860, y: 465 },
      mur: [{ x: 60, y: 300, b: 240, h: 60 }, { x: 640, y: 500, b: 360, h: 60 }],
      hylde: { rampe:  2 },
      loesning: [{ slags: 'rampe', x: 440, y: 340, vinkel: 0 }, { slags: 'rampe', x: 180, y: 140, vinkel: 40 }] },
    { navn: 'uglehullet', kapitel: 'natten',
      start: { x: 500, y: 60 }, maal: { x: 140, y: 545 },
      mur: [{ x: 360, y: 260, b: 280, h: 60 }, { x: 60, y: 580, b: 260, h: 60 }, { x: 340, y: 380, b: 40, h: 240 }],
      hylde: { blaeser:  1,  tragt:  1 },
      loesning: [{ slags: 'blaeser', x: 720, y: 160, vinkel: 270 }, { slags: 'tragt', x: 700, y: 380, vinkel: 0 }] },
    { navn: 'stjerneskud', kapitel: 'natten',
      start: { x: 120, y: 60 }, maal: { x: 880, y: 225 },
      mur: [{ x: 60, y: 340, b: 240, h: 60 }, { x: 500, y: 120, b: 40, h: 500 }, { x: 740, y: 260, b: 260, h: 60 }],
      hylde: { kanon:  2 },
      loesning: [{ slags: 'kanon', x: 100, y: 180, vinkel: 45 }, { slags: 'kanon', x: 620, y: 200, vinkel: 45 }] },
    { navn: 'maanen', kapitel: 'natten',
      start: { x: 860, y: 60 }, maal: { x: 140, y: 245 },
      mur: [{ x: 620, y: 360, b: 380, h: 60 }, { x: 440, y: 160, b: 40, h: 460 }, { x: 60, y: 280, b: 260, h: 60 }],
      hylde: { vippe:  1,  kanon:  1 },
      loesning: [{ slags: 'vippe', x: 240, y: 520, vinkel: 0 }, { slags: 'kanon', x: 840, y: 300, vinkel: 315 }] },
    { navn: 'moerket', kapitel: 'natten',
      start: { x: 140, y: 60 }, maal: { x: 860, y: 545 },
      mur: [{ x: 60, y: 260, b: 300, h: 60 }, { x: 400, y: 420, b: 200, h: 40, stof: 'sten' }, { x: 640, y: 580, b: 360, h: 60 }],
      hylde: { baand:  1,  tragt:  1,  rampe:  1 },
      loesning: [{ slags: 'baand', x: 820, y: 180, vinkel: 180 }, { slags: 'tragt', x: 740, y: 380, vinkel: 0 }, { slags: 'rampe', x: 120, y: 160, vinkel: 40 }] },
    { navn: 'den-store-maskine', kapitel: 'natten',
      start: { x: 120, y: 60 }, maal: { x: 500, y: 545 },
      mur: [{ x: 60, y: 240, b: 220, h: 60 }, { x: 780, y: 240, b: 220, h: 60 }, { x: 300, y: 380, b: 40, h: 240 }, { x: 660, y: 380, b: 40, h: 240 }, { x: 400, y: 580, b: 200, h: 60 }],
      hylde: { kanon:  1,  tragt:  1,  vippe:  1,  rampe:  1 },
      loesning: [{ slags: 'kanon', x: 420, y: 200, vinkel: 270 }, { slags: 'tragt', x: 600, y: 340, vinkel: 0 }, { slags: 'vippe', x: 820, y: 480, vinkel: 0 }, { slags: 'rampe', x: 180, y: 140, vinkel: 40 }] }
  ];
