...
Der er ikke aendret i filerne, kun filnavnene er oversat til danske ord.

Resten af Rimhulens ord er Bogstavvejens ting og hentes fra
`../bogstaver/billeder/` og `../bogstaver/ting/`, saa intet ligger to gange.
Listen `EKSTRA` i `js/rim.js` er de ord, der ligger her.
