...
De fleste ting har i dag et malet billede i `../billeder/` (se NOTICE.md dér)
og bruger ikke længere SVG'en. Kun de ting, der endnu ikke er malet, ligger her.
...
`fil: sti('<navn>')` på tingen i js/ting.js. Tilføj filen i sw.js.
