 ...
 * skriver dem. Buer laves med bue(), saa der ikke skal skrives 30 punkter
 * i haanden.
 *
...
(function (rod) {
  ...
  var GLYFFER = {
    A: { tegn: 'A', streger: [streg([20, 90], [50, 10], [80, 90]), streg([32, 62], [68, 62])] },
    B: { tegn: 'B', streger: [streg([25, 10], [25, 90]),
                               sammen([[25, 10], [55, 10]], cirkel(55, 30, 20, -90, 90), [[25, 50]]),
                               sammen([[25, 50], [57, 50]], cirkel(57, 70, 20, -90, 90), [[25, 90]])] },
    C: { tegn: 'C', streger: [cirkel(50, 50, 38, -50, -310)] },
    D: { tegn: 'D', streger: [streg([25, 10], [25, 90]),
                               sammen([[25, 10], [45, 10]], cirkel(45, 50, 40, -90, 90), [[25, 90]])] },
    E: { tegn: 'E', streger: [streg([75, 10], [25, 10], [25, 90], [75, 90]), streg([25, 50], [65, 50])] },
    F: { tegn: 'F', streger: [streg([75, 10], [25, 10], [25, 90]), streg([25, 50], [65, 50])] },
    ...
    M: { tegn: 'M', streger: [streg([20, 90], [20, 10], [50, 60], [80, 10], [80, 90])] },
    N: { tegn: 'N', streger: [streg([25, 90], [25, 10], [75, 90], [75, 10])] },
    O: { tegn: 'O', streger: [cirkel(50, 50, 40, -90, -450)] },
    P: { tegn: 'P', streger: [streg([25, 90], [25, 10]), sammen([[25, 10], [55, 10]], P, [[25, 54]])] },
    Q: { tegn: 'Q', streger: [cirkel(50, 50, 40, -90, -450), streg([60, 65], [84, 92])] },
    R: { tegn: 'R', streger: [streg([25, 90], [25, 10]), sammen([[25, 10], [55, 10]], P, [[25, 54]]), streg([45, 54], [75, 90])] },
    ...
    AE: { tegn: 'Æ', streger: [streg([12, 90], [42, 10], [42, 90]), streg([42, 10], [84, 10]), streg([24, 58], [42, 58], [74, 58]), streg([42, 90], [84, 90])] },
    OE: { tegn: 'Ø', streger: [cirkel(50, 50, 40, -90, -450), streg([76, 14], [24, 86])] },
    AA: { tegn: 'Å', streger: [streg([20, 92], [50, 30], [80, 92]), streg([33, 70], [67, 70]), cirkel(50, 13, 8, -90, -450)] },
    ...
    d: { tegn: 'd', streger: [cirkel(50, 62, 18, -30, -330), streg([68, 12], [68, 80])] },
    ...
    g: { tegn: 'g', streger: [cirkel(50, 62, 18, -30, -330), sammen([[68, 45], [68, 86]], cirkel(54, 86, 14, 0, 180))] },
    h: { tegn: 'h', streger: [streg([32, 12], [32, 80]), sammen([[32, 62]], cirkel(50, 62, 18, -180, 0), [[68, 80]])] },
    ...
    ae: { tegn: 'æ', streger: [cirkel(34, 62, 18, -30, -330), sammen([[50, 62], [84, 62]], cirkel(66, 62, 18, 0, -300))] },
    oe: { tegn: 'ø', streger: [cirkel(50, 62, 18, -90, -450), streg([64, 44], [36, 80])] },
    aa: { tegn: 'å', streger: [cirkel(48, 66, 16, -30, -330), streg([64, 50], [64, 82]), cirkel(56, 32, 4, -90, 270)] }
  };
