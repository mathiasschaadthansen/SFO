...
(function () {
  ...
  function Styring(element) {
    ...
    this.tastKort = {
      ...
      ArrowUp:    { spiller: 0, knap: 'hop' },
      a: { spiller: 1, knap: 'venstre' },
      d: { spiller: 1, knap: 'hoejre' },
      w: { spiller: 1, knap: 'hop' }
    };
